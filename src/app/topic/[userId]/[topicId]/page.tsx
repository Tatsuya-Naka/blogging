    ...
    return (
        <HydrateClient>
            ...
            <main className="block flex-1 pt-[56px] text-[18px] box-border bg-bg">
                <div className="...">
                    <div
                        className="text-[1rem] w-full max-w-[1380px] mx-auto grid md:gap-[0.5rem] md:grid-cols-[4rem_1fr] lg:grid-cols-[4rem_7fr_3fr] md:p-[1rem] lg:gap-[1rem]  md:row-span-2"
                    >
                        <TopicLeft />
