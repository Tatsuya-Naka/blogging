...
export default function EditTopicContent({ userData }: Props) {
    ...
    const handleDialogClose = () => {
        ...
        router.push(`/topic/${userId}/${topicId}`);
    };

    const mutation = trpc.topic.saveTopic.useMutation();
    ...
    const savePost = async(e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log("Error occured during updating topic: ", err);
        }
    };
