    ...
    return (
        <div>
            <div className="bax-border py-0 h-full w-full object-contain rounded-t-[0.375rem] max-h-[calc(90vh - 56px)] overflow-hidden block">
                <a href="#" className="object-contain rounded-t-customForCenterPage max-h-[calc(90vh - 56px)]">
                    ...
                    <Image
                        ...
                        width={1000}
                        height={420}
                        className="w-full h-auto aspect-[5/2] object-cover max-h-[420px] max-w-[1000px] overflow-hidden"
                    />
                </a>
            </div>
